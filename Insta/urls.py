...
from Insta.views import (HelloWorld, PostsView, PostCreateView, PostDetailView, PostUpdateView, PostDeleteView, addLike, addComment, UserProfile, EditProfile, toggleFollow, ExploreView, SignUp)
